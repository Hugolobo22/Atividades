...
console.log("Tamanho da string:", programmingLanguage.length);
...
let x = randomWord.length;
let y = x - 1;
console.log("Último índice: ", randomWord[y]);
...
console.log("String em minúsculas:", summerMessage.toLowerCase());
...
console.log("String em maiúsculas:", winterMessage.toUpperCase());
...
console.log("Índice: ", winterMessage.indexOf('v'));
...
console.log("Último índice: ", winterMessage.lastIndexOf('n'));
...
console.log("Recorte: ", harryPotterAuthor.slice(0, 4));
...
const realBestMovie =  bestMovie.slice(0, -13) + "Moonlight";
...
const allEpisodes = `nº de episódios é: ${episodes}`;
